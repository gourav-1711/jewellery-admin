...
export default function CategoriesPage() {
  ...
  const loadSelectCategories = async () => {
    setLoading(true)
    try {
  ...
  const loadCategories = async () => {
    ...
    try {
      ...
      setCategories(Array.isArray(data?._data) ? data._data : Array.isArray(data) ? data : [])
    } catch (error) {
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between animate-in fade-in slide-in-from-top duration-300">
        <div>
          ...
          <p className="text-muted-foreground">Organize your products into sub categories</p>
        </div>
      ...
      >
        <div className="space-y-4">
          ...
          <div className="space-y-2 animate-in slide-in-from-right duration-300 delay-75 ">
           ...
           <NewMultiSelect category={subCategories} categoryId={categoryId} setCategoryId={setCategoryId} />
          </div>
